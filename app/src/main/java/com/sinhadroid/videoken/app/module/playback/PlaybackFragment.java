package com.sinhadroid.videoken.app.module.playback;
...
public class PlaybackFragment extends DialogFragment {
    ...
    public PlaybackFragment newInstance(VideoKen item) {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnRecordListener) {
            mOnRecordListener = (OnRecordListener) context;
        }
    }
